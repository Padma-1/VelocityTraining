...
public class Dealer {
	...
	private Date dob; //date format :  YEAR-MONTH-DATE
	...
	//  use above lines if u want to create Address class in seperate. But as MongodB is non-structured database, we can write all in one table as well.
