...
public class ProductController {
	...
	{
		List<Product> listProducts=pservice.listAll(); //listAll() method is defined in ProductService
    ...
    public ModelAndView showEditProductPage(@RequestParam("id") int id) {
        ...
        Product product = pservice.get(id);	//get method is defined in ProductService
