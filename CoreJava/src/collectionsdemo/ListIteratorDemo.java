...
//program to travers elist in forward and backward direction.
public class ListIteratorDemo {
	...
	public static void main(String[] args) {
		...
		// Bcoz of above code, listIt is at last position and hence backward iteration
		// works.
		// If we comment above block of code, then Backward iteration will not be done.
		// To work use below line,
