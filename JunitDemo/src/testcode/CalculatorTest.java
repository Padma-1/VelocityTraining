...
public class CalculatorTest {
	...
	@Test
	public void testAdd() {
		double add = calc.add(10.5, 20.32); //test fixture
...
/*	@Test
	public void testDivide() {
		double div = calc.divide(100.5, 5);
		assertEquals(20, div, 0.2); //delta value is the diff which can be accepted between Actual and Expected.
	}
*/
